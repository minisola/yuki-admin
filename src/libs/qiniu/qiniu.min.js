/*! qiniu-js-sdk v1.0.13-beta | Copyright 2015 by Qiniu */ ! function(global) {
	...
	function QiniuJsSDK() {
		...
		var qiniuUploadUrl;
		qiniuUploadUrl = "https:" === window.location.protocol ? "https://up.qbox.me" : "http://up-z2.qiniu.com";
		var qiniuUploadUrls = ["http://up-z2.qiniu.com", "http://up.qiniu.com"];
		var changeUrlTimes = 0;
		this.resetUploadUrl = function() {
			if ("https:" === window.location.protocol) qiniuUploadUrl = "https://up-z2.qbox.me";
			else {
			...
			var c = function() {
				if (a.uptoken) that.token = a.uptoken;
					...
					},b.setRequestHeader("token",localStorage.token), b.send()
				}
			};
