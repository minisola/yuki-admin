...
//       html += "<option value='" + this.id + "'>" + this.agencyName + '</option>'
//     })
//     $('#agencyId')
//       .append(html)
//       .select2({
...
//       var html = "<option value=''>全部</option>"
//       $.each(res.data, function () {
//         html += "<option value='" + this.id + "'>" + this.projectName + '</option>'
//       })
//       if (!projectsInit) {
//         projectsInit = 1
...
//         case '新增':
//           top.addNavTab('12', '新建运单', '/static/page/transport_road/edit.html')
//           break
//         case '编辑':
...
//             if (el.isPolicy == 1) {
//               _u.getTemplate('/static/page/transport_road/policy_tip.html', function (html) {
//                 _u.zlmsg.open({
//                   type: 1,
//                   title: '投保提示',
//                   content: html,
...
//           if (totalCount > 10000)
//             return layer.alert('不支持大于10000条的运单导出,请通过创建时间筛选运单再试')
...
//                     exportListWidth.push($(this).data('width').toString() || '0')
//                   }
//                 })
...
//           }
//           _u.fullDialog({
//             content: '/static/page/transport_road/edit.html?mode=copy&id=' + el.id,
//           })
//           break
//         case '复制运单编号':
//           var els = _u.getSelectedItem(true)
...
//             content:
//               '/static/page/transport_road/seeEtc.html?waybillCode=' + els.data[0].waybillCode,
//             scrollbar: false,
//             area: ['90%', '90%'],
//           })
//           break
...
//             },
//             btn2: function () {
//               location.href = env.appUrl + '/truckWaybill/excelOut?token=' + localStorage.token
//               return false
//             },
//           })
//       }
